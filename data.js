/* =======================================================
   data.js
   Datos de los planes de estudio — NO MODIFICAR aquí los
   valores; si necesitas actualizar un curso, edítalo
   directamente en este archivo (es el único que lo contiene).
======================================================= */
const planesEstudio = {
    "2017": {
            ...
            },
            {
                ...
                semestres: [
                    { nombre: "Primer Semestre", cursos: [
                        ...
                        { codigo: "1703140", nombre: "Electrónica Industrial (E)", cred: 3, prq: ["1702229", "1702230"] }, silabo: "https://drive.google.com/file/d/1mEH-o2BUw_uhhl5lg_4Hz1j-gyC_JE3c/view?usp=drive_link",
